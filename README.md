...
The study proposes a hybrid approach that seeks to minimise JSE-listed IT investors’ risk exposure by combining financial analysis with ML, using the Altman Z-score to screen financially healthy companies and then apply RF and XGBoost ML models to predict the entry (buy) and sell (exit) signals.
